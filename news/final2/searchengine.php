                    ...
                    if ($result->num_rows > 0) {
                        ...
                        if($searchView->num_rows > 0){
                            ...
                            while($viewData=$searchView->fetch_array(MYSQLI_ASSOC)){
                                    ...
                                    //Malaysiakini----ONLINE PORTALS BEGIN********************
                                    //********************************************************//
                                    
                                    if($viewData['media_organization_website']=='http://www.malaysiakini.com/'){
                                    ...
                                    //************************END ******************************//
                                     ...
                                     //http://themalaysianreserve.com----ONLINE PORTALS BEGIN********************
                                    //********************************************************//
                                    
                                    if($viewData['media_organization_website']=='http://themalaysianreserve.com/main/'){
                                                
                                                    $authorName = $viewData['media_contact_name'];

                                                    //$searchstring=str_replace(" ", "%20", $viewData['media_contact_name']);

                                                    $url="http://themalaysianreserve.com/new/search/node/$authorName";
                                                    ...
                                                    $dom->loadHTML($html);
                                                        ...
                                                        $contentsArray =  array();
                                                         ...
                                                         foreach($dom->getElementsByTagName("ol") as $element) {
                                                        ...
                                                        foreach($dom->getElementsByTagName('h3') as $heading){
                                                            ...
                                                            foreach($dom->getElementsByTagName('a') as $anchors){
                                                        //$body .= $dom->saveHTML($postdate);
                                                        array_push($anchorsArray, $anchors->getAttribute( 'href' ));
                                                        }
                                                        ...
                                                        $results = $xpath->query("//*[@class='" . $classname . "']");
                                                            ...
                                                            //echo $review = $results->item(0)->nodeValue;
                                                             //$body .= $dom->saveHTML($results->item(0));
                                                                ...
                                                                //$body .= $dom->saveHTML($result);
                                                                array_push($postdateArray, strip_tags($dom->saveHTML($result)));
